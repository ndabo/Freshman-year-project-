...
public class DecisionTreeTester<G extends ITreeGenerator<D>, D extends IDataset> {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Dataset trainingData = makeDataset("data/simple.csv", Dataset.class);
            double accuracy =
                    tester.getDecisionTreeAccuracy(trainingData, trainingData, "Outcome");
            System.out.println("Accuracy on training data: " + accuracy);

            int numIters = 100;
            Dataset testingData = makeDataset("data/simple.csv", Dataset.class);
            accuracy = tester.getAverageDecisionTreeAccuracy(trainingData, testingData, "Outcome", numIters);
